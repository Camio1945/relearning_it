...
/**
 * 分支预测示例。
 * 全部使用 if-else 语句，概率最大的情况放在最后面判断。
 * 来源：https://www.infoq.cn/article/G5VCEcw7bP4RGXsRU-J8
 * @author Camio1945
 */
public class BranchPrediction3IfElse3MajorLast {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("BranchPrediction3IfElse3MajorLast   result: " + result +
        ", rate: " + rate +
